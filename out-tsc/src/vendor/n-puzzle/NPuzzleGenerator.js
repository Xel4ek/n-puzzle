...
export class NPuzzleGenerator {
    ...
    */
    constructor(size, key = 'solvable') {
        this.size = size;
        this.key = key;
        this.instance = [...Array(this.size * this.size).keys()].sort((a, b) => 0.5 - Math.random());
    }
    generate() {
...
//# sourceMappingURL=NPuzzleGenerator.js.map